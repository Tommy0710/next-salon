        ...
        <div className="p-4 min-h-screen bg-gray-50 dark:bg-slate-900 dark:border-gray-700 text-black">
            ...
            <div className="bg-white rounded-xl border border-gray-200 dark:bg-slate-900 dark:border-gray-700 shadow-sm overflow-hidden">
                ...
                <MobileCardList
                    items={logs}
                    loading={loading}
                    emptyIcon={<History className="w-14 h-14" />}
                ...
                {/* Pagination */}
                <div className="flex-col md:flex-row gap-4 flex-col md:flex-row gap-4 px-6 py-4 bg-gray-50 dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:bg-slate-800/50 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between">
