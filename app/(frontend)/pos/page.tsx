                ...
                {isMounted && activeBill && (
                    <div className="bg-white dark:bg-slate-900 flex flex-col flex-1 min-h-0">
                        ...
                        <div className="flex-shrink-0 p-3 bg-gray-50 dark:bg-slate-900 dark:border-gray-700 border-t border-gray-200 dark:border-slate-800 overflow-y-auto max-h-[50vh] md:max-h-[45%] pb-20 md:pb-3 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                            ...
                            {/* ── Cancel Edit Banner — chỉ hiện khi đang sửa hóa đơn ── */}
                            {activeBill?.editInvoiceId && (
                                <div className="mb-3 px-3 py-2.5 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/50 rounded-xl flex items-center justify-between gap-3">
                                    <div className="flex items-center gap-2 min-w-0">
                                        <Edit className="w-3.5 h-3.5 text-amber-600 dark:text-amber-400 shrink-0" />
                                        <span className="text-xs font-semibold text-amber-700 dark:text-amber-300 truncate">
                                            Đang chỉnh sửa hóa đơn
                                        </span>
                                    </div>
                                    <button
                                        onClick={() => {
                                        ...
                                        className="flex items-center gap-1 px-2.5 py-1 bg-white dark:bg-slate-800 hover:bg-red-50 dark:hover:bg-red-900/20 text-red-600 dark:text-red-400 border border-red-200 dark:border-red-800 rounded-lg text-xs font-bold transition-colors shrink-0"
                                    >
                                        <X className="w-3 h-3" />
                                        Hủy
                                    </button>
